  ...
  <div>
    ...
    <v-dialog v-model="dialog" width="800px">
      <v-card>
          ...
          <v-layout row wrap>
            <v-flex xs12>
              <v-menu
                ref="datePicker"
                lazy
                :close-on-contecnt-click="flase"
                v-model="transactionDatePicker"
                transaction="scale-transaction"
                offset-y
                full-width
                :nudge-right="40"
                max-width="290px"
              ...
              >
                <v-text-field
                  ...
                  v-model="trnsaction.transactionDate"
                  prepend-icon="event"
                  readonly
                  >
                </v-text-field>
                <v-date-picker
                  ...
                  v-on:input="$refs.datePicker.save(transactionDate)"
                >
                </v-date-picker>
              </v-menu>
            </v-flex>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn flat color="primary" @click="dialog = flase">Cancel</v-btn>
...
export default {
  ...
  data: () => ({
    ...
    transactionTypes: [
      ...
      { text: 'Debit Card', value: 'Devit Card' },
